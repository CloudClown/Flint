...
var TodoList = (function(_, $) {
  ...
  TodoList.prototype.addTask = function(title, id) {
    ...
    var $img = $('<a href="https://www.google.com/"><img height="34px", width="34px"/></a>');
    var $imgNew = $img.find('img');
    $imgNew.attr('src', 'http://images1.fanpop.com/images/photos/2100000/Blake-Lively-blake-lively-2125657-1024-768.jpg');
    $li.text(' ' + title).prepend($img);
    this.$list.append($li);
  };
